...
namespace Neuro.Layers
{
    public class Dense : LayerBase
    {
        ...
        internal override void SerializeParameters(XmlElement elem)
        {
            ...
            XmlAttribute outputShapes = elem.OwnerDocument.CreateAttribute("outputShapes");
            outputShapes.Value = Output.Length.ToString();
            elem.Attributes.Append(outputShapes);

            XmlAttribute ActivationFunc = elem.OwnerDocument.CreateAttribute("ActivationFunc");
            ActivationFunc.Value = Activation.ToString();
            elem.Attributes.Append(ActivationFunc);
        }
